/* Handle the location drop down in the campaign form
 * Fetching data from the geonames service */

(function(){

  // Initialize the location drop down
  var initLocation = function (lang){
    ...
    // Load locations from geonames service
